...
2. No detached instances — frames that visually duplicate a library component without actually being an instance of it. If you can't verify this (no tree-walk capability available), say **NOT VERIFIED**, never pass it silently.
3. It's an actual component or component set, not a frame styled to look like one.
